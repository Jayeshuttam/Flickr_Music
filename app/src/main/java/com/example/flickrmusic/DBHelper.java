...
public class DBHelper extends SQLiteOpenHelper {
    public final static String DATABASE_PATH = "/data/data/com.example.flickrmusic/databases/";
    ...
    public ArrayList<Users> getAppCategoryDetail() {
...
//                    Log.e("Working", cursor.getBlob(cursor.getColumnIndex("image")) + "");
    ...
    public void insertUser(String firstName, String secondName, String email, String password) {
